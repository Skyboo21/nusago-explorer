                ...
                <div class="card glass-card shadow-lg rounded-4 p-4">
                    <div class="card-body">
                        ...
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <button type="submit" class="inline-flex items-center justify-center rounded-2xl bg-primary w-full py-3 text-sm font-semibold text-white shadow-sm hover:bg-teal-800 transition-all active:scale-95 text-decoration-none mt-2 mb-3">Daftar Akun</button>
                        </form>
