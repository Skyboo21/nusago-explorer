...
<head>
    ...
    <style>
        ...
        .navbar-brand { color: #e63946 !important; font-weight: 700; letter-spacing: 1px; }
        .nav-link { font-weight: 600; color: #2b2d42 !important; margin: 0 5px; transition: color 0.3s ease; }
        .nav-link:hover { color: #e63946 !important; }
        .btn-custom { background-color: #e63946; color: white; border-radius: 30px; padding: 8px 25px; font-weight: 600; transition: 0.3s; }
        .btn-custom:hover { background-color: #d62828; color: white; box-shadow: 0 4px 15px rgba(230, 57, 70, 0.4); }
        footer { background-color: #1d3557; color: white; }
    </style>
</head>
<body>
                                ...
                                @if(Auth::user()->role === 'admin')
                                    <li>
                                        <a class="dropdown-item fw-bold py-2" href="{{ route('admin.dashboard') }}">
                                            <i class="fa-solid fa-shield-halved me-2 text-danger"></i>Admin Panel
                                        </a>
                                    </li>
                                @endif
                            </ul>
